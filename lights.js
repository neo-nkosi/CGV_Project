...
const createLights = (scene) => {
 ...
 scene.add(candle2);
  ...
  specialpointLightstairs.target.position.set(-2.07, -0.19, -2.63); // Set the light's target
  ...
  pointLightstairs.target.position.set(0.1, 0.0, 0.06); // Set the light's target
  ...
  pointLightstairs2.target.position.set(-1.8, 0.0, -0.06); // Set the light's target
  ...
  pointLightstairs3.target.position.set(-2.4, 0.0, -3.01); // Set the light's target
  ...
  pointLightstairs4.target.position.set(-2.7, 0.0, 0.62); // Set the light's target
  ...
  pointLightstairs5.target.position.set(-5.4, 0.0, 1.18); // Set the light's target
  ...
  pointLightstairs6.target.position.set(-4.73, 0.0, -1.93); // Set the light's target
  ...
  pointLightstairs7.target.position.set(-3.1, 0.0, -4.08); // Set the light's target
  ...
  pointLightstairs8.target.position.set(-6.25, 0.0, 0.10); // Set the light's target
  ...
  pointLightstairs9.target.position.set(-8.4, 0.0, -1.11); // Set the light's target
  ...
  pointLightstairs1.target.position.set(-5.43, 0.0, -4.5); // Set the light's target
